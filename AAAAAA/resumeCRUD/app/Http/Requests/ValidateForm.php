...
class ValidateForm extends FormRequest
{
    ...
    {
        return [
            'FIO' => 'required|unique:people|string|regex:/^\w{1,}\s\w{1,}\s\w{1,}$/iu',
    ...
    public function messages(): array
    {
        return [
            ...
            'FIO.unique' => 'Фу, плагиат в ФИО',
            'FIO.string' => 'Вы больше чем число, имя в строку пожалуйста',
            'FIO.regex' => 'ФИО  в три слова',

            'Stuff.required' => 'Какого ваше профессьё?',
            'Stuff.numeric' => 'Профессьё нормально укажите',
